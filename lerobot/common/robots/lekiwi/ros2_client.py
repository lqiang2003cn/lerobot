...
from .config_ros2 import Ros2ClientConfig

logging.getLogger().setLevel(logging.INFO)


# pull data from Ros2, so it's a ros2 client
class Ros2Client(Robot):
    config_class = Ros2ClientConfig
    name = "ros2_client"

    def __init__(self, config: Ros2ClientConfig):
    ...
    def connect(self) -> None:
        ...
        # push commands to host, we don't need it, we use moveit servo to send commands to the robot
        ...
        logging.info("connecting ros2 host...")
        socks = dict(poller.poll(self.connect_timeout_s * 100000))
        logging.info("ros2 host connected")
